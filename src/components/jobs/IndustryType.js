...
import { DELETE_INDUSTRY_TYPE } from "../../utils/constants";
...
const IndustryType = () => {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete) {
      try {
        ...
        const response = await fetch(`${DELETE_INDUSTRY_TYPE}${id}`, {
          method: "DELETE",
          headers: {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: "Hindi",
        accessor: "ind_type_hindi",
        sortType: "alphanumeric", // Set sortType for sorting
      },
      {
        Header: "Marathi",
        accessor: "ind_type_marathi",
        sortType: "alphanumeric", // Set sortType for sorting
      },
      {
        Header: "Punjabi",
        accessor: "ind_type_punjabi	",
        sortType: "alphanumeric", // Set sortType for sorting
      },
      {
        Header: "Actions",
  ...
  const data = useMemo(() => positions?.data?.industryType || [], [positions]);
...
export default LayoutHOC(IndustryType);
